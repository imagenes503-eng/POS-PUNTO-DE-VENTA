  ...
  try {
    ...
    if (vd && vd.length > 0) {
      ...
      vd.forEach(row => {
        ...
        if (typeof ventasDiariasEliminadas !== 'undefined' && ventasDiariasEliminadas.includes(fechaLimpia)) { console.log('[Diag-VD] fila descartada, tombstone:', fechaLimpia); return; }
