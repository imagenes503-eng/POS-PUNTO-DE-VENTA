...
async function restaurarSesion() {
  ...
  try {
    ...
    setTimeout(_autoFusionar, 300);
    // SYNC FIX: repintado de respaldo — garantiza que Estado de Caja quede
    // correcto una vez que AutoCarga y AutoFusionar ya tuvieron tiempo de
    // terminar, sin depender de que el usuario cambie de página para verlo.
