...
function _apBuildPedidosHoy() {
  ...
  html += '<span>Pendientes: '+(pedidos.length-totalRec)+'</span><span style="color:#ea580c;">Recibidos: '+totalRec+' / '+pedidos.length+'</span></div>';
  html += '<div style="width:100%;height:8px;background:#e2e8f0;border-radius:20px;overflow:hidden;">';
  html += '<div style="height:100%;border-radius:20px;background:linear-gradient(90deg,#ea580c,#fb923c);width:'+pct+'%;transition:width .4s;"></div></div></div>';
...
function _apInyectarCSS() {
  ...
  s.textContent = [
    ...
    // HERO
    '.ap-hero{background:linear-gradient(145deg,#020d07 0%,#7c2d12 45%,#7c2d12 75%,#9a3412 100%);padding:24px 18px 22px;margin-bottom:20px;position:relative;overflow:hidden;}',
    '.ap-hero-inner{position:relative;z-index:1;}',
    '.ap-eyebrow{font-size:10px;font-weight:900;color:#fb923c;text-transform:uppercase;letter-spacing:1.6px;font-family:Nunito,sans-serif;margin-bottom:5px;}',
    ...
    '.sv{color:#fdba74;}.sa{color:#93c5fd;}.sn{color:#fcd34d;}.sw{color:#fff;}',
    // CUERPO
    ...
    '.ap-hoy-act{border-color:#fed7aa;background:linear-gradient(135deg,#fffbeb,#ffedd5);}',
    ...
    '.ap-hoy-ico-act{background:#ffedd5;}.ap-hoy-ico-idle{background:#f1f5f9;}',
    '.ap-hoy-title{font-size:13px;font-weight:900;font-family:Nunito,sans-serif;}',
    '.ap-hoy-title-act{color:#9a3412;}.ap-hoy-title-idle{color:var(--text-muted,#64748b);}',
    ...
    '.ico-verde{background:#ffedd5;}.ico-azul{background:#dbeafe;}.ico-naranja{background:#fef3c7;}',
    '.ap-panel-txt{flex:1;}',
    ...
    '.ap-badge{min-width:26px;height:26px;padding:0 8px;border-radius:30px;display:inline-flex;align-items:center;justify-content:center;font-size:12px;font-weight:900;font-family:Nunito,sans-serif;background:#ffedd5;color:#c2410c;border:1px solid #fed7aa;}',
    ...
    '.ap-inp:focus{border-color:#ea580c;box-shadow:0 0 0 3px rgba(234,88,12,.1);}',
    ...
    '.ap-btn-green{background:linear-gradient(135deg,#ea580c,#c2410c);color:#fff;box-shadow:0 4px 14px rgba(234,88,12,.35);}',
    ...
    '.ap-av{width:38px;height:38px;border-radius:50%;background:linear-gradient(135deg,#ea580c,#65a30d);display:flex;align-items:center;justify-content:center;font-size:13px;font-weight:900;color:#fff;font-family:Nunito,sans-serif;flex-shrink:0;text-transform:uppercase;}',
    ...
    // PANEL PEDIDOS HOY
    '.ap-pedidos{background:var(--surface2,#f8fafc);border:1.5px solid #fed7aa;border-radius:20px;overflow:hidden;box-shadow:0 2px 16px rgba(234,88,12,.1);}',
    '.ap-pedidos-hdr{display:flex;align-items:center;gap:11px;padding:15px 17px 14px;background:linear-gradient(135deg,#7c2d12,#9a3412);}',
    ...
    '.ap-ped-pendiente:hover{border-color:#fed7aa;}',
    '.ap-ped-recibido{background:#fffbeb;border-color:#fed7aa;}',
    ...
    '.ap-ped-av-recibido{background:linear-gradient(135deg,#ea580c,#65a30d);}',
    '.ap-ped-nombre{font-size:14px;font-weight:900;font-family:Nunito,sans-serif;}',
    '.ap-ped-nombre-pendiente{color:var(--text,#0f172a);}.ap-ped-nombre-recibido{color:#c2410c;}',
    '.ap-ped-sub{font-size:11px;font-weight:700;font-family:Nunito,sans-serif;margin-top:2px;}',
    '.ap-ped-sub-pendiente{color:var(--text-muted,#94a3b8);}.ap-ped-sub-recibido{color:#ea580c;}',
    ...
    '.ap-ped-badge-recibido{background:#ffedd5;color:#c2410c;border:1px solid #fed7aa;}',
    ...
    '.ap-btn-recibir:hover{background:linear-gradient(135deg,#ea580c,#c2410c);border-color:#c2410c;color:#fff;box-shadow:0 3px 10px rgba(234,88,12,.3);transform:translateY(-1px);}',
    // PANEL PREVENTAS HOY
    ...
    '.ap-prev-av-phecho{background:linear-gradient(135deg,#ea580c,#65a30d);}',
    ...
    '.ap-prev-badge-phecho{background:#ffedd5;color:#c2410c;border:1px solid #fed7aa;}',
