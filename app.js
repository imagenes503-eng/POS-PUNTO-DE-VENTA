...
function abrirConfigPin() {
    ...
    <div style="background:#fff;border-radius:20px;width:100%;max-width:340px;box-shadow:0 24px 60px rgba(0,0,0,0.4);overflow:hidden;">
      ...
      <div style="padding:20px 22px;">
        ...
        <div style="text-align:right;margin-bottom:10px;">
          <span id="cpOlvide" style="font-size:11px;font-weight:800;color:#c2410c;text-decoration:underline;cursor:pointer;">¿Olvidaste tu contraseña actual?</span>
        </div>
        ` : ''}
  ...
  if (linkOlvide) {
    linkOlvide.onclick = () => {
      if (!confirm('Esto borra la contraseña actual (sin necesidad de saberla) para que puedas crear una nueva. Mientras tanto, las acciones sensibles quedarán SIN pedir contraseña. ¿Continuar?')) return;
      localStorage.removeItem(_PIN_STORAGE_KEY);
      toast('Contraseña anterior borrada — crea una nueva abajo');
      abrirConfigPin(); // vuelve a dibujar el modal ya en modo "crear contraseña"
    };
  }
}
