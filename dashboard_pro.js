  ...
  cont.innerHTML = `
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin-bottom:16px;">
      ...
      <div style="background:#fff;border:1.5px solid #e5e7eb;border-radius:14px;overflow:hidden;">
        ...
        ${horaPicoTxt ? `
        <div style="margin:10px 14px 0;background:linear-gradient(135deg,#fff7ed,#ffedd5);border:1px solid #fdba74;border-radius:10px;padding:8px 10px;display:flex;align-items:center;gap:8px;">
          <div style="font-size:16px;">🔥</div>
          <div style="min-width:0;">
            <div style="font-size:10px;font-weight:900;color:#9a3412;text-transform:uppercase;letter-spacing:.3px;">Tu hora pico (todos los días)</div>
            <div style="font-size:12px;font-weight:900;color:#7c2d12;">${horaPicoTxt} <span style="font-weight:700;color:#c2410c;">· ${horaPicoCant} venta${horaPicoCant!==1?'s':''}</span></div>
          </div>
        </div>` : ''}
