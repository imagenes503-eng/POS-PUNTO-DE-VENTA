...
function renderDashboardPro() {
  ...
  cont.innerHTML = `
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:12px;margin-bottom:16px;">
      <div style="background:linear-gradient(135deg,#fffbeb,#ffedd5);border:2px solid #fdba74;border-radius:14px;padding:16px;position:relative;overflow:hidden;">
        <div style="font-size:22px;margin-bottom:6px;">💰</div>
        <div style="font-family:'Space Mono',monospace;font-size:22px;font-weight:900;color:#c2410c;">$${totalHoy.toFixed(2)}</div>
        <div style="font-size:10px;font-weight:900;color:#c2410c;text-transform:uppercase;letter-spacing:.5px;margin-top:4px;">Ventas hoy</div>
        <div style="font-size:10px;color:#fb923c;font-weight:700;margin-top:2px;">${numVentas} transacciones</div>
      </div>
      <div style="background:linear-gradient(135deg,#fffbeb,#ecfdf5);border:2px solid #bef264;border-radius:14px;padding:16px;">
        <div style="font-size:22px;margin-bottom:6px;">✨</div>
        <div style="font-family:'Space Mono',monospace;font-size:22px;font-weight:900;color:#65a30d;">$${gananciaHoy.toFixed(2)}</div>
        <div style="font-size:10px;font-weight:900;color:#65a30d;text-transform:uppercase;letter-spacing:.5px;margin-top:4px;">Ganancia</div>
        <div style="font-size:10px;color:#a3e635;font-weight:700;margin-top:2px;">Margen ${margenHoy}%</div>
      </div>
